 ...
 */
public class GovernmentClientsJPanel extends javax.swing.JPanel {
    JPanel userProcessContainer;
    ApplicationSystem system;
    DefaultTableModel viewTableModel;

    /**
     * Creates new form ManageGovernmentClientsJPanel
     */
    public GovernmentClientsJPanel() {
        initComponents();
    }
    
    GovernmentClientsJPanel(JPanel userProcessContainer, ApplicationSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Government Clients");
        ...
        deleteClientButton.setText("Delete Government Client");
        deleteClientButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deleteClientButtonActionPerformed(evt);
            }
        });
        add(deleteClientButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 460, -1, 30));
