...
public class ViewHospitalOrderDetails extends javax.swing.JPanel {
    ...
    public void generateChart(){
        ...
        {
            if(hospital.equals(co.getClient().getClientType())){
                System.out.println("This is a hospital"+co.getClient().getClientType());
    ...
    private void initComponents() {
        ...
        add(barChartJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 190, 650, 400));
